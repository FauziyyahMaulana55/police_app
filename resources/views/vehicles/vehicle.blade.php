                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editVehicleForm">
                            ...
                            <div class="mb-3">
                                <label for="edit_is_stolen" class="form-label">Stolen</label>
                                <div class="d-flex">
                                    <div class="form-check me-3">
                                        <input class="form-check-input" type="radio" name="edit_is_stolen"
                                            id="edit_is_stolen_yes" value="1">
                                        <label class="form-check-label" for="edit_is_stolen_yes">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="edit_is_stolen"
                                            id="edit_is_stolen_no" value="0">
